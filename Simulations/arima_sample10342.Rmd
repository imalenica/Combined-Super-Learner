---
title: "MIMIC ARIMA Sample 10342"
...
plot_multi(multi_forecast = arima_abpsys$plot_data[[5]]$multi_forecast,
           test_outcome = arima_abpsys$plot_data[[5]]$test)
...
```{r, echo = FALSE, out.height='65%', out.width='65%', fig.align="center"}
plot_all(onestep_forecast = arima_abpsys$plot_data[[5]]$onestep_forecast,
         multi_forecast = data.frame(arima_abpsys$plot_data[[5]]$multi_forecast)[,1],
         test_outcome = arima_abpsys$plot_data[[5]]$test)
```

```{r, echo = FALSE, fig.align="center"}
tsdisplay(arima_abpsys$residuals[[5]],
...
plot_multi(multi_forecast = arima_abpdias$plot_data[[5]]$multi_forecast,
           test_outcome = arima_abpdias$plot_data[[5]]$test)
```

```{r, echo = FALSE, out.height='75%', out.width='75%', fig.align="center"}
plot_all(onestep_forecast = arima_abpdias$plot_data[[5]]$onestep_forecast,
         multi_forecast = data.frame(arima_abpdias$plot_data[[5]]$multi_forecast)[,1],
         test_outcome = arima_abpdias$plot_data[[5]]$test)   
```

```{r, echo = FALSE, fig.align="center"}
tsdisplay(arima_abpdias$residuals[[5]],
...
```{r, echo = FALSE, out.height='75%', out.width='75%', fig.align="center"}
plot_multi(multi_forecast = arima_abpmean$plot_data[[5]]$multi_forecast,
           test_outcome = arima_abpmean$plot_data[[5]]$test)
```

```{r, echo = FALSE, out.height='75%', out.width='75%', fig.align="center"}
plot_all(onestep_forecast = arima_abpmean$plot_data[[5]]$onestep_forecast,
         multi_forecast = data.frame(arima_abpmean$plot_data[[5]]$multi_forecast)[,1],
         test_outcome = arima_abpmean$plot_data[[5]]$test)
```

```{r, echo = FALSE, fig.align="center"}
tsdisplay(arima_abpmean$residuals[[5]],
