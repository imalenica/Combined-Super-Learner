...
**Later I will model the binary or continuous MIMIC outcome data with GLARMA or ARIMA, respectively. If the GLARMA/ARIMA model seems to be suitable for modeling the MIMIC data, then I can create a simulated dataset with the fitted model.** 
...
* [A Short Introduction to ARIMA](https://www.datascience.com/blog/introduction-to-forecasting-with-arima-in-r-learn-data-science-tutorials)

* [Time Series: AR, MA, ARMA, ARIMA](http://people.cs.pitt.edu/~milos/courses/cs3750/lectures/class16.pdf)
...
```{r, sim_wt_ts-plots1, fig.align="center", echo=FALSE, out.width= "60%", out.height= "60%"}
...
```{r, sim_wt_ts-plots2, fig.align="center", echo=FALSE, out.width= "60%", out.height= "60%"}
...
```{r, sim_wt_ts-plots3, fig.align="center", echo=FALSE, out.width= "60%", out.height= "60%"}
...
```{r, sim_wt_ts-plots4, fig.align="center", echo=FALSE, out.width= "60%", out.height= "60%"}
