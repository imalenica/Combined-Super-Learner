---
title: "MIMIC ARIMA Sample 10013"
...
plot_multi(multi_forecast = arima_abpsys$plot_data[[1]]$multi_forecast,
           test_outcome = arima_abpsys$plot_data[[1]]$test)
...
plot_all(onestep_forecast = arima_abpsys$plot_data[[1]]$onestep_forecast,
         multi_forecast = data.frame(arima_abpsys$plot_data[[1]]$multi_forecast)[,1],
         test_outcome = arima_abpsys$plot_data[[1]]$test)
```

```{r, echo = FALSE, fig.align="center"}
tsdisplay(arima_abpsys$residuals[[1]],
...
plot_multi(multi_forecast = arima_abpdias$plot_data[[1]]$multi_forecast,
           test_outcome = arima_abpdias$plot_data[[1]]$test)
```

```{r, echo = FALSE, out.height='75%', out.width='75%', fig.align="center"}
plot_all(onestep_forecast = arima_abpdias$plot_data[[1]]$onestep_forecast,
         multi_forecast = data.frame(arima_abpdias$plot_data[[1]]$multi_forecast)[,1],
         test_outcome = arima_abpdias$plot_data[[1]]$test)   
```

```{r, echo = FALSE, fig.align="center"}
tsdisplay(arima_abpdias$residuals[[1]],
...
```{r, echo = FALSE, fig.align="center"}
tsdisplay(arima_abpmean$residuals[[1]],
