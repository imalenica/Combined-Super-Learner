...
save(comSLsim_res, file = here::here("Results/Nonstationary_ts", paste0("CombineSL_results_cvro_", id, ".Rdata")), compress = TRUE)
save(comSLsim_res_cvrw, file = here::here("Results/Nonstationary_ts", paste0("CombineSL_results_cvrw_", id, ".Rdata")), compress = TRUE)
```

```{r, echo=FALSE, eval=TRUE}
load(here::here("Results/Nonstationary_ts", "CombineSL_results_cvro_20403.Rdata"))
load(here::here("Results/Nonstationary_ts", "CombineSL_results_cvrw_20403.Rdata"))
times <-as.list(seq(30, 300, by = 30))
